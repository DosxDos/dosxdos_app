async function loadFirebase() {
    try {
        ...
        onMessage(messaging, (payload) => {
            ...
            const icon = payload.data.icon || "http://localhost:8080/img/logo-red.png";
            const click_action = "http://localhost:8080/notificaciones.html";
...
function notificarWebApp() {
    try {
        ...
        if (dataNativa != null) {
            ...
            const icon = data.icon || "http://localhost:8080/img/logo-red.png";
            const click_action = data.click_action || "http://localhost:8080/notificaciones.html";

...
function populateMobileMenu(userRole) {
  ...
  const mobileMenuItems = {
    admon: [
      {
        id: "archivos",
        href: "http://localhost:8080/ot.html",
        icon: renderIcon(`
      ...
      {
        id: "icLineasOt",
        href: "http://localhost:8080/lineas_ot.html",
        icon: renderIcon(`
      ...
      {
        id: "rutasIcono",
        href: "http://localhost:8080/rutas.html",
        icon: renderIcon(`
      ...
      {
        id: "lineasIcono",
        href: "http://localhost:8080/lineas.html",
        icon: renderIcon(`
      ...
      `),
        submenu: [
          {
            href: "http://localhost:8080/gastos_rutas.html",
            text: "Gastos Rutas"
          },
          {
            href: "",
      ...
      `),
        submenu: [
          {
            href: "http://localhost:8080/ots_clientes.html",
            text: "Restricciones Tipos de OT"
          },
          {
            href: "http://localhost:8080/firmas_clientes.html",
      ...
      {
        id: "usuarios",
        href: "http://localhost:8080/dosxdos.php?modulo=usuarios",
        icon: renderIcon(`
      ...
      `),
        ...
        //   },
        //   {
        //     href: "http://localhost:8080/apirest/sincronizador2.php",
        //     text: "Sinc. Total OT Navision"
        //   }
        // ]
      }, {
        id: "cursos",
        href: "http://localhost:8080/cursos.html",
        icon: renderIcon(`
          <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
          <polyline points="14 2 14 8 20 8" />
          <path d="M16 13H8" />
...
`), text: "Líneas Ruta"
    ...
    montador: [
      {
        id: "rutasMontador",
        href: "http://localhost:8080/rutas_montador.html",
        icon: renderIcon(`
          <svg viewBox="0 0 100 100" class="w-6 h-6 mr-2" fill="none" stroke="currentColor"
          xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true"
          role="img" preserveAspectRatio="xMidYMid meet">
    ...
    `), text: "Rutas"
      ...
      {
        id: "lineasMontador",
        href: "http://localhost:8080/ruta_montador.html",
        icon: renderIcon(`
          <svg class="w-6 h-6 mr-2" fill="currentColor" stroke="none" viewBox="-3 0 32 32" version="1.1"
     xmlns="http://www.w3.org/2000/svg">
     <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
...
`), text: "Líneas"
      ...
      {
        id: "historial",
        href: "http://localhost:8080/historial_montador.html",
  ...
  notificationLink.href = "http://localhost:8080/notificaciones.html";
...
function setupUserActions() {
  ...
  if (editarUsuario) {
    editarUsuario.addEventListener("click", e => {
      if (navigator.onLine) {
        window.location.href = "http://localhost:8080/dosxdos.php?modulo=editarUsuario&id=" + usuario.id;
      } else {
...
function createDesktopNavigation(userRole) {
  ...
  desktopBell.href = "http://localhost:8080/notificaciones.html";
  desktopBell.className = "relative z-10 inline-flex items-center";
  desktopBell.id = "desktopBellContainer";
  desktopBell.innerHTML = `
    <div class="relative">
      <img id="bellDesktop" src="http://localhost:8080/img/bell2.png" class="w-7 text-gray-900 object-contain" />
  ...
  userMenu.innerHTML = `
    <button id="userMenuButton"
      ...
      <div
        ...
        <img id="imagenUsuario" src="http://localhost:8080/img/usuario.png"

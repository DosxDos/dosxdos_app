if (navigator.onLine) {
    ...
    messaging.onBackgroundMessage((payload) => {
        ...
        const notificationOptions = {
            ...
            icon: payload.data.icon || 'http://localhost/dosxdos_app/img/dosxdoslogoNuevoRojo.png',
            data: {
                url: payload.data.click_action || 'http://localhost/dosxdos_app/notificaciones.html'
            }
        };
    ...
    self.addEventListener('notificationclick', (event) => {
        ...
        let url = event.notification.data?.url || 'http://localhost/dosxdos_app/notificaciones.html';

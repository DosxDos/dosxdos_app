...
<section class="container mx-auto px-4 pt-32 pb-12">
    <!-- Page Header -->
        ...
        <div class="p-6">
            ...
            <div class="relative flex items-center w-full mb-8">
                <input type="text" id="customSearch"
                    class="w-full h-12 pl-4 pr-4 border border-gray-300 rounded-lg text-lg focus:outline-none focus:ring-2 focus:ring-red-600 transition-all text-black placeholder-gray-400"
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr class="border-b border-gray-100 hover:bg-gray-50 cursor-pointer" data-user-id="<?php echo $row['id']; ?>" data-user-info='<?php echo $userDataJson; ?>'>
                                    <td class="px-4 py-3">
                                        <img src="<?php echo $row['imagen'] ?: 'img/usuario.png'; ?>" class="w-12 h-12 rounded-full border border-gray-200 object-cover" alt="Usuario">
                                    </td>

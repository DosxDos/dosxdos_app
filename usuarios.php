...
<div class="px-4 pt-32 pb-12 bg-gray-100 min-h-screen">
    <section class="container mx-auto  w-full">
        ...
        <div class="rounded-xl shadow-lg overflow-hidden relative mb-6">
            <div class="absolute inset-0" style="background-image: url('http://localhost/dosxdos_app/img/texture-red.svg'); background-size: contain;"></div>
            <div class="relative p-10 flex justify-between items-start md:items-center text-white">
                ...
                <!-- Create User Button -->
                <a href="http://localhost/dosxdos_app/dosxdos.php?modulo=crearUsuario"
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex justify-center">
                        <div class="w-24 h-24 rounded-full overflow-hidden border-2 border-gray-200 shadow-md">
                            <img id="userModalImage" src="http://localhost/dosxdos_app/img/usuario.png"
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        function populateUserModal(data, userData, rowElement) {
            ...
            if (userData && typeof userData === 'object') {
                document.getElementById('userModalImage').src = userData.imagen || 'http://localhost/dosxdos_app/img/usuario.png';
            ...
            // Extract image URL
            let imgSrc = 'http://localhost/dosxdos_app/img/usuario.png';
        ...
        editUserModal.addEventListener('click', () => {
            if (currentUserId) {
                window.location.href = `http://localhost/dosxdos_app/dosxdos.php?modulo=editarUsuario&id=${currentUserId}`;
            } else {

...
const CACHE_NAME = 'dosxdos113',
  urlsToCache = [
    ...
    'http://localhost/dosxdos_app/historial_montador.html',
    'http://localhost/dosxdos_app/linea_historial_montador.html',
    ...
    'http://localhost/dosxdos_app/img/historial.png',
    'http://localhost/dosxdos_app/css/tailwindmain.css',
    'http://localhost/dosxdos_app/firebase-messaging-sw.js',
    'http://localhost/dosxdos_app/img/dosxdoslogoNuevoRojo.png',
    'http://localhost/dosxdos_app/js/notificaciones.js',
    'http://localhost/dosxdos_app/js/navigation.js',
    'http://localhost/dosxdos_app/js/loadFirebase.js',
    'http://localhost/dosxdos_app/img/bell.gif',
    'http://localhost/dosxdos_app/img/bell2.png',
    'http://localhost/dosxdos_app/img/Isotipo-38.png',
    'http://localhost/dosxdos_app/notificaciones.html',
    'http://localhost/dosxdos_app/img/texture-red.svg',
    'http://localhost/dosxdos_app/img/texture-white.svg',
    'http://localhost/dosxdos_app/css/index.css',
    'http://localhost/dosxdos_app/gsap.min.js',
    'http://localhost/dosxdos_app/js/informe_ot.js',
    'http://localhost/dosxdos_app/css/informe_ot.css',
    'http://localhost/dosxdos_app/js/pdf_informe_ot.js',
    'http://localhost/dosxdos_app/js/informe_ot_visuales_montajes.js',
    'http://localhost/dosxdos_app/css/informe_ot_visuales_montajes.css',
    'http://localhost/dosxdos_app/js/pdf_informe_ot_visuales_montajes.js'
  ],

...
<body id="body" class="bg-gray-100">
        ...
        <div class="flex items-center justify-between w-full px-6 py-4">
            ...
            <nav class="hidden xl:flex items-center space-x-8">
                ...
                <a href="http://localhost:8080/notificaciones.html" class="relative z-10" id="desktopBellContainer">
                    <img id="bellDesktop" src="http://localhost:8080/img/bell2.png" class="text-gray-900 object-contain" />
    ...
    <div class="container mx-auto px-4 sm:px-6 pb-12 pt-32">
        ...
        if (!$curso) {
            ...
            echo "<script>window.location.href = 'http://localhost:8080/cursos.html';</script>";
        } else {
            if (!$modulo) {

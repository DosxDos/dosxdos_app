...
<head>
    ...
    <link rel="stylesheet" href="http://localhost:8080/css/informe_ot_visuales_montajes.css?v=1" />
    ...
    <script src="http://localhost:8080/js/informe_ot_visuales_montajes.js?v=1"></script>
</head>
...
<body class="bg-gray-50 min-h-screen p-4 flex flex-col items-center justify-start">
    ...
    <script src="http://localhost:8080/js/pdf_informe_ot_visuales_montajes.js?v=1"></script>

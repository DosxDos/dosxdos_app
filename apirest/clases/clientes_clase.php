                ...
                if ($result) {
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        if (file_exists($pathArchivo)) {
                            ...
                            $foto['link'] = 'http://localhost:8080/fotos/' . $row['ano'] . '/' . $row['ot'] . '/' . $row['nombre'];
                            $foto['nombre'] = $row['nombre'];
                            $foto['ruta'] = $row['ruta'];
                ...
                if ($result) {
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        if (file_exists($pathArchivo)) {
                            ...
                            $foto['id'] = $row['id'];
                            $foto['nombre'] = $row['nombre'];
                            $foto['link'] = 'http://localhost:8080/firmas/' . $row['ano'] . '/' . $row['ot'] . '/' . $row['nombre'];
                            $foto['nombre'] = $row['nombre'];
                            $foto['ruta'] = $row['ruta'];
                            $foto['linea'] = $row['linea'];
                            $foto['ot'] = $row['ot'];
                ...
                if ($result) {
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        if (file_exists($pathArchivo)) {
                            ...
                            $foto['id'] = $row['id'];
                            $foto['nombre'] = $row['nombre'];
                            $foto['link'] = 'http://localhost:8080/carpetas/' . $row['ano'] . '/' . $row['ot'] . '/' . $row['nombre'];
                            $foto['nombre'] = $row['nombre'];
                            $foto['ruta'] = $row['ruta'];
                            $foto['linea'] = $row['linea'];
                            $foto['ot'] = $row['ot'];

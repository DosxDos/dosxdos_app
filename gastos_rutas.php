...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] == "POST") {
        ...
        $json = '{ "callback": {"url": "http://localhost:8080/callBackBulkCrm.php", "method": "post"}, "query": {"module": {"api_name": "Products"},"criteria": {"comparator": "between","field": {"api_name": "Fecha_actuaci_n"}, "value": [' . '"' . $fecha1 . '"' . ',' . '"' . $fecha2 . '"' . ']}}}';

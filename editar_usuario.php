    ...
    <div class="container mx-auto">
        ...
        <section class="mb-8">
            <div class="rounded-xl shadow-lg overflow-hidden relative">
                <div class="absolute inset-0"
                    style="background-image: url('http://localhost/dosxdos_app/img/texture-red.svg'); background-size: contain;">
                </div>
        ...
        <section class="mb-8">
            <div class="flex flex-col md:flex-row gap-3">
                <!-- Back Button -->
                <?php if ($clase == 'admon') { ?>
                    <a href="http://localhost/dosxdos_app/dosxdos.php?modulo=usuarios" class="flex items-center gap-2 text-red-600 mb-3 md:mb-0">
                ...
                <?php } else if ($clase == 'montador') { ?>
                    <a href="http://localhost/dosxdos_app/rutas_montador.html" class="flex items-center gap-2 text-red-600 mb-3 md:mb-0">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" viewBox="0 0 20 20" fill="currentColor">
                            <path fill-rule="evenodd" d="M9.707 16.707a1 1 0 01-1.414 0l-6-6a1 1 0 010-1.414l6-6a1 1 0 011.414 1.414L5.414 9H17a1 1 0 110 2H5.414l4.293 4.293a1 1 0 010 1.414z" clip-rule="evenodd" />
                        </svg>
                        <span class="font-medium">Volver</span>
                ...
                <?php } else { ?>
                    <a href="http://localhost/dosxdos_app/ot.html" class="flex items-center gap-2 text-red-600 mb-3 md:mb-0">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" viewBox="0 0 20 20" fill="currentColor">
                            <path fill-rule="evenodd" d="M9.707 16.707a1 1 0 01-1.414 0l-6-6a1 1 0 010-1.414l6-6a1 1 0 011.414 1.414L5.414 9H17a1 1 0 110 2H5.414l4.293 4.293a1 1 0 010 1.414z" clip-rule="evenodd" />
                        </svg>
                        <span class="font-medium">Volver</span>
            ...
            <div class="p-6">
                <form action="editar_usuario.php" method="post" id="editarUsuarioFormulario" enctype="multipart/form-data" class="space-y-6" novalidate>
                    ...
                    <div class="flex flex-col-reverse md:flex-row gap-3 pt-4 border-t border-gray-200">
                        <?php if ($clase == 'admon') { ?>
                            <a href="http://localhost/dosxdos_app/dosxdos.php?modulo=usuarios" id="cancelar" class="w-full">
                        ...
                        <?php } else if ($clase == 'montador') { ?>
                            <a href="http://localhost/dosxdos_app/rutas_montador.html" id="cancelar" class="w-full">
                                <button type="button" class="w-full flex items-center justify-center gap-2 bg-gray-300 hover:bg-gray-400 text-gray-800 py-3 px-6 rounded-lg shadow-md transition-all text-base font-medium">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
                                    </svg>
                        ...
                        <?php } else { ?>
                            <a href="http://localhost/dosxdos_app/ot.html" id="cancelar" class="w-full">
                                <button type="button" class="w-full flex items-center justify-center gap-2 bg-gray-300 hover:bg-gray-400 text-gray-800 py-3 px-6 rounded-lg shadow-md transition-all text-base font-medium">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
                                    </svg>
                        ...
                        <?php if ($clase == 'admon') { ?>
                            <a href="http://localhost/dosxdos_app/editar_usuario.php?eliminar=1&id=<?php echo $id ?>" class="eliminar w-full">
        ...
        <script src="http://localhost/dosxdos_app/js/navigation.js"></script>
        <script>
        ...
        <script src="http://localhost/dosxdos_app/js/notificaciones.js"></script>
        <script src="http://localhost/dosxdos_app/js/loadFirebase.js"></script>